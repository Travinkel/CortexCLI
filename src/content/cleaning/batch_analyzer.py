...
from .atomicity import CardQualityAnalyzer, QualityReport
...
class BatchQualityAnalyzer:
        ...
        if min_grade:
            ...
            if min_grade in grade_order:
                ...
                where_clauses.append(
                    f"quality_grade IN ({','.join(':grade_' + str(i) for i in range(len(allowed_grades)))})"
                )
    ...
    def analyze_single_card(
        self, front: str, back: str | None = None, atom_type: str = "flashcard"
    ) -> QualityReport:
        """
    ...
    def analyze_with_semantic(
        ...
        try:
            ...
            if generate_embeddings:
                ...
                semantic_results["embeddings_generated"] = embedding_result.get(
                    "records_processed", 0
                )
