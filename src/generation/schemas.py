    ...
    "properties": {
        ...
        "metadata": {
            ...
            "properties": {
                ...
                "knowledge_type": {"type": "string", "enum": ["factual", "conceptual", "procedural"]},
                "blooms_level": {"type": "string"},
                "derived_from_visual": {"type": "boolean"},
                # --- FIDELITY TRACKING ---
                "is_hydrated": {"type": "boolean", "description": "True if scenario NOT in source text"},
                "fidelity_type": {"type": "string", "enum": ["verbatim_extract", "rephrased_fact", "ai_scenario_enrichment"]},
                "source_fact_basis": {"type": "string", "maxLength": 300},
            },
            "required": ["difficulty", "knowledge_type", "is_hydrated", "fidelity_type"],
        },
    },
    "required": ["atom_id", "atom_type", "front", "options", "correct_index", "explanation", "metadata", "source_refs"],
}
...
TRUE_FALSE_SCHEMA = {
    ...
    "required": ["atom_id", "atom_type", "front", "correct", "explanation", "metadata", "source_refs"],
}
...
PARSONS_SCHEMA = {
    ...
    "required": ["atom_id", "atom_type", "scenario", "correct_sequence", "starting_mode", "metadata", "source_refs"],
}
...
NUMERIC_SCHEMA = {
    ...
    "properties": {
        ...
        "calculation_type": {
            "type": "string",
            "enum": ["binary_decimal", "hex_decimal", "subnetting", "and_operation", "cidr_calculation"],
    ...
    "required": ["atom_id", "atom_type", "front", "back", "calculation_type", "metadata", "source_refs"],
}
