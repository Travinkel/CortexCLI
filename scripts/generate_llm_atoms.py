...
from src.generation.llm_generator import LLMFlashcardGenerator, GeneratedCard
...
def main():
    ...
    parser.add_argument("--replace", action="store_true", help="Replace existing LLM-generated cards")
