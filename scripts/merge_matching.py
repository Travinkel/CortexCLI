"""Merge matching atoms into cortex_master.json."""
import json
import uuid
from pathlib import Path

def main():
    atoms_file = Path("outputs/generated_atoms/matching_atoms.json")
    if not atoms_file.exists():
        print("ERROR: matching_atoms.json not found")
        return
    ...
    print(f"Total matching atoms: {matching_count}")
