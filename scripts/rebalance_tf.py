...
def apply_negation(statement: str) -> Optional[str]:
    """
...
def main():
    ...
    with engine.connect() as conn:
        ...
        logger.info(f"Current distribution: TRUE={true_count} ({100*true_count/total:.1f}%), FALSE={false_count} ({100*false_count/total:.1f}%)")
